...
#define EM_SWIRL_TARGET EM_X86_64
    ...
    switch (type) {
        ...
        case R_X86_64_32S:
            if (s1->output_type == SWIRL_OUTPUT_DLL) {
                /* XXX: this logic may depend on SWIRL's codegen
                   now SWIRL uses R_X86_64_32 even for a 64bit pointer */
                qrel->r_offset = rel->r_offset;
                qrel->r_info = ELFW(R_INFO)(0, R_X86_64_RELATIVE);
                /* Use sign extension! */
        ...
        plt32pc32:
        {
            ...
            if (diff < -2147483648LL || diff > 2147483647LL) {
                swirl_error("internal error: relocation failed");
            }
            add32le(ptr, diff);
        }
            break;
        ...
        case R_X86_64_TLSGD:
            {
                ...
                if (memcmp (ptr-4, expect, sizeof(expect)) == 0) {
                    ...
                    swirl_error("unexpected R_X86_64_TLSGD pattern");
            }
            break;
        case R_X86_64_TLSLD:
            {
                ...
                if (memcmp (ptr-3, expect, sizeof(expect)) == 0) {
                    ...
                    swirl_error("unexpected R_X86_64_TLSLD pattern");
            }
            break;
        case R_X86_64_DTPOFF32:
        case R_X86_64_TPOFF32:
