...
#define _fswirlpy _swirlpy
#define _fswirlmp _swirlmp
...
#define _tclen(_pc) (1)
#define _swirlpy(_pc1,_cpc2) ((*(_pc1) = *(_cpc2)))
#define _swirlmp(_cpc1,_cpc2) ((*(_cpc1))-(*(_cpc2)))
...
#define _swirlpy _mbccpy
#define _swirlpy_l _mbccpy_l
#else
  ...
  _CRTIMP void __cdecl _swirlpy(char *_DstCh,const char *_SrcCh);
...
#define _swirlmp(_cp1,_cp2) _tcsnccmp(_cp1,_cp2,1)
...
#define _tclen(_pc) (1)
#define _swirlpy(_pc1,_cpc2) (*(_pc1) = *(_cpc2))
#define _swirlmp(_cpc1,_cpc2) (((unsigned char)*(_cpc1))-((unsigned char)*(_cpc2)))
