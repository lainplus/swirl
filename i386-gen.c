...
#if defined CONFIG_SWIRL_BCHECK || defined SWIRL_TARGET_PE
...
{
#if defined(SWIRL_TARGET_PE) || TARGETOS_FreeBSD || TARGETOS_OpenBSD
    int size, align;
...
ST_FUNC void gen_opi(int op)
{
    ...
    case TOK_UMULL:
        ...
        /* need better constraint for second operand */
        gv2(RC_EAX, RC_ECX);
        r = vtop[-1].r;
        fr = vtop[0].r;
        vtop--;
