/*
 *  CIL code generator for Swirl
 */

#error this code has bit-rotted since 2003 lmao
                           ...
                           int t, const char *varstr)
{
    ...
    add_tstr:
        ...
        break;
    case VT_STRUCT:
        swirl_error("structures not handled yet");
        break;
    case VT_FUNC:
...
void gfunc_param(GFuncContext *c)
{
    if ((vtop->t & VT_BTYPE) == VT_STRUCT) {
        swirl_error("structures passed as value not handled yet");
    } else {
