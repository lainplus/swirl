...
/* with -D C2STR: convert swirldefs.h to C-strings */
...
const char *platform_macros[] = {
    "__i386__",             "SWIRL_TARGET_I386",
    "__x86_64__",           "SWIRL_TARGET_X86_64",
    "_WIN32",               "SWIRL_TARGET_PE",
    "__arm__",              "SWIRL_TARGET_ARM",
    "__ARM_EABI__",         "SWIRL_ARM_EABI",
    "__aarch64__",          "SWIRL_TARGET_ARM64",
    "__riscv",              "SWIRL_TARGET_RISCV64",
    "__APPLE__",            "SWIRL_TARGET_MACHO",
